...
Tags: salesforce, contact form 7, cf7
Requires at least: 3.9
Tested up to: 4.3
Stable tag: 4.3

Plugin to integrate Contact Form with salesforce to convert Contact Form queries to web leads.
...
* [Contact Form 7](https://downloads.wordpress.org/plugin/contact-form-7.4.2.1.zip) - Contact Form 7 can manage multiple contact forms, plus you can customize the form and the mail contents flexibly with simple markup. The form supports Ajax-powered submitting, CAPTCHA, Akismet spam filtering and so on..

== Installation ==

1. Upload `cf7-salesforce-web-to-lead` to the `/wp-content/plugins/` directory
